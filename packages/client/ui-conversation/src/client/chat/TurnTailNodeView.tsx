...
export const TurnTailNodeView = memo(function TurnTailNodeView({
  node, openFile, downloadFile, forkAt, renderSlot, renderSlotChain, t, useSession,
  ...
  const owner: TurnTailOwnerProps = { turn, seq: closing?.finalNode.seq ?? data.seq, openFile, downloadFile }
