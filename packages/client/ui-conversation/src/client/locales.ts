...
export const zh = {
  ...
  'steps.title': '中间步骤',
  'steps.showBoth': '显示工具调用与思考',
  'steps.hideToolCalls': '隐藏工具调用',
  'steps.hideReasoning': '隐藏思考',
  'steps.hideBoth': '隐藏工具调用与思考',
  'steps.working': '正在执行…',
...
export const en = {
  ...
  'steps.title': 'Intermediate steps',
  'steps.showBoth': 'Show tool calls & reasoning',
  'steps.hideToolCalls': 'Hide tool calls',
  'steps.hideReasoning': 'Hide reasoning',
  'steps.hideBoth': 'Hide tool calls & reasoning',
